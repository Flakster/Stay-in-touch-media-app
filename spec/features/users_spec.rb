...
RSpec.feature 'Users', type: :feature do
  context 'user friendship requests' do
    before(:each) do
      User.create(name: 'User 1 test', email: 'user1@mail.com', password: '123456')
      User.create(name: 'User 2 test', email: 'user2@mail.com', password: '123456')
      User.create(name: 'User 3 test', email: 'user3@mail.com', password: '123456')
      visit root_path
      within('form') do
